...
export function Content () {
    return (
        <>
            <main className='md:bg-gradient-to-br md:from-blue-900'>
                <div></div>
                <section className='h-screen px-24 py-14 dark:bg-blue-gray-900 backdrop-blur-sm' id='home'>
                    <div className='flex py-6' >
                        <h2 className='text-5xl'>Inicio</h2>
                    ...
                    <div className='grid justify-end align-bottom div-home'>
                        <div className='p-6'>
                            ...
                            <h2 className='title-1 text-3xl'> Hola, soy <strong className='text-[#ff7832]'>Anderson Tovar</strong>! ✌️ </h2>
                        </div>
                        {/* <div className='p-6'>
                            <div className='flex align-bottom justify-end py-12'>
                                <svg className="mx-2 w-8 h-8 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <h2 className='title-2 text-3xl'> Hola, soy <strong className='text-[#ff7832]'>@anderbars_sw</strong>! ✌️ </h2>
                        </div> */}
                    </div>
                    <p className='text-end text-xl py-4'>Tengo <strong className='text-[#ff7832]'>+2</strong> años de experiencia como <strong className='text-yellow-400'>FullStack Developer</strong>, tengo la capacidad de desarrollar tanto el <strong className='text-blue-700 border-b-2 border-blue-700'>frontend</strong> como el <strong className='text-[#ff7832] border-b-2 border-[#ff7832]'>backend</strong> de las aplicaciones web, utilizando diferentes lenguajes, frameworks y herramientas.</p>
                </section>
                <div></div>
