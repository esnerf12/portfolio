                    ...
                    <div className='grid justify-end align-bottom div-home'>
                        <div className='md:p-6'>
                            <div className='flex align-bottom justify-end py-6 md:py-12'>
                                ...
                                <svg className="mx-2 w-8 h-8 md:w-12 md:h-12 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 19">
