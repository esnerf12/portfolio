...
export function Content () {
    ...
    return (
        <>
            <main>
                <div></div>
                <section ref={containerRefHome} className='h-screen px-24 py-14 bg-gradient-to-br from-blue-700' id='home'>
                    ...
                    <div className='grid justify-end align-bottom div-home'>
                        <div className={ isVisibleHome ? 'text-3xl text-white transform cursor-pointer p-6 opacity-100 transition duration-1000 ease-in-out' : 'text-3xl text-white transform opacity-0 transition duration-1000 ease-in-out cursor-pointer p-6' }>
                            ...
                            <span className='text-black drop-shadow-2xl'> Hola, soy <strong className='text-[#ff7832]'>@anderbars_sw</strong>! ✌️ </span>
                        </div>
                        <div className={ isVisibleHome ? 'text-3xl text-white transform rotate-180 opacity-0 transition duration-1000 ease-in-out cursor-pointer p-6' : 'text-3xl text-white transform rotate-0 opacity-100 transition duration-1000 ease-in-out cursor-pointer p-6' }>
                            <span className='text-black drop-shadow-2xl'> ✌️ Hola, soy <strong className='text-[#ff7832]'>Anderson Tovar</strong>!</span>
                ...
                <div></div>
                <section className='px-24 py-14 bg-gradient-to-tr from-blue-700' id='projects'>
                    <div className='flex py-6 transform hover:scale-[1.035] transition duration-500'>
                ...
                <div></div>
                <section className='px-24 py-10 bg-gradient-to-br from-blue-700' id='about'>
