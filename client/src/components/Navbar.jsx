      ...
      <nav className="overflow-auto">
        <ul className="text-right p-16">
          ...
          <a className="hover:no-underline" href="#">
            <li className="flex hover:bg-[#030d4f] cursor-pointer p-2">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z" />
              </svg>
              <span className="px-1">Dark theme</span>
            </li>
          </a>
          <a className="hover:no-underline" href="#">
            <li className="flex hover:bg-[#030d4f] cursor-pointer p-2">
          ...
          <a className="hover:no-underline" href="#home">
            <li className="flex justify-end hover:bg-[#fb0c06] cursor-pointer p-2">
          ...
          <a className="hover:no-underline" href="https://github.com/esnerf12">
            <li className="flex align-bottom cursor-pointer hover:bg-sky-100 p-2">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
